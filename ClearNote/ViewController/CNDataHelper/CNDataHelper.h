...
//+(void)localMoveToTrashWithUserID:(NSString *)userID noteCreateID:(NSString *)noteCreateID isDeleted:(NSString *)isDeleted noteName:(NSString *)noteName tempUserId:(NSString *)tempUserId isSynchoronization:(NSString *)isSynchoronization;
...
//+(void)localPermanentlyDeleteWithUserID:(NSString *)userID noteCreateID:(NSString *)noteCreateID isDeleted:(NSString *)isDeleted noteName:(NSString *)noteName tempUserId:(NSString *)tempUserId isSynchoronization:(NSString *)isSynchoronization;
...
//+(void)localRestoreNoteWithUserID:(NSString *)userID noteCreateID:(NSString *)noteCreateID isDeleted:(NSString *)isDeleted noteName:(NSString *)noteName tempUserId:(NSString *)tempUserId isSynchoronization:(NSString *)isSynchoronization;
