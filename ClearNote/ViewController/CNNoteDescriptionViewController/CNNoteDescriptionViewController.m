...
-(void)backBtnAction
{
    ...
    if(tempNoteID == noteID)   // no api call
    {
         [self.navigationController popViewControllerAnimated:YES];
...
{   NSString * currentTimestamp = nil;
    ...
    if(requestId == Request_Update_Note_Contant)
    {
        ...
        {
            [CNDataHelper localWrtingAndEditNoteUpdateWithUserId:get_ValueByKye(kLoginID) noteCreateID:noteID tempUserId:tempUserId content:strTextView noteName:strTextField updateNoteDateTime:timeStampDate isSynchoronization:@"0"];
            ...
            // net is working
            [self loderStop:self.view];
            [CNDataHelper CNdBWrtingAndEditNoteWithUserId:[CNHelper sharedInstance].userLoginID noteCreateID:noteID tempUserId:tempUserId contant:strTextView noteName:strTextField updateNoteDateTime:timeStampDate isDeleted:@"0" timeStamp:timeStamp noteCreateDate:noteCreteDate isSynchoronization:@"0"];
    ...
    else if(requestId == Request_Move_Trash_Note)
    {
        ...
        if ([[AFNetworkReachabilityManager sharedManager] isReachable])
        {
            ...
            [CNDataHelper localMoveToTrashWithUserID:[CNHelper sharedInstance].userLoginID noteCreateID:noteID isDeleted:@"1" noteName:strTextField tempUserId:tempUserId noteCreateDate:noteCreteDate isSynchoronization:@"0"];
        ...
        else
        {
            ...
            [CNDataHelper CNdBMoveTrashWithUserID:[CNHelper sharedInstance].userLoginID noteCreateID:noteID isDeleted:@"1" noteName:strTextField tempUserId:tempUserId noteCreateDate:noteCreteDate fileData:strTextView timeStamp:timeStamp isSynchoronization:@"0"];
            [self nextNoteRelaod];
...
{   NSString *message = nil;
    ...
    if(requestId == Request_Update_Note_Contant)
    {
        ...
        {
            [self loderStop:self.view];
            [CNDataHelper localWrtingAndEditNoteUpdateWithUserId:get_ValueByKye(kLoginID) noteCreateID:noteID tempUserId:tempUserId content:strTextView noteName:strTextField updateNoteDateTime:timeStampDate isSynchoronization:@"1"];
    ...
    else if(requestId == Request_Move_Trash_Note)
    {
        ...
        if([code isEqualToString:@"200"])
        {
            ...
            [CNDataHelper localMoveToTrashWithUserID:[CNHelper sharedInstance].userLoginID noteCreateID:responseData[@"noteId"] isDeleted:responseData[@"isDeleted"]noteName:strTextField tempUserId:tempUserId noteCreateDate:noteCreteDate isSynchoronization:responseData[@"isSynchronise"]];
            [self.btnTrash setEnabled:YES];
            [self nextNoteRelaod];
    ...
    else if(requestId == Request_Move_Trash_Note_Back)
    {
        ...
        {
            [self loderStop:self.view];
            [CNDataHelper localMoveToTrashWithUserID:[CNHelper sharedInstance].userLoginID noteCreateID:noteID isDeleted:responseData[@"isDeleted"] noteName:strTextField tempUserId:tempUserId noteCreateDate:noteCreteDate isSynchoronization:responseData[@"isSynchronise"]];
