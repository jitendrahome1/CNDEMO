...
//                                                                utilityButtonSelector:@selector(leftUtilityButtonHandler:)];
    ...
    UIView *clipViews[] = {self.rightUtilityClipView };
    NSLayoutConstraint *clipConstraints[] = {self.rightUtilityClipConstraint };
    UIView *buttonViews[] = {self.rightUtilityButtonsView };
    NSLayoutAttribute alignmentAttributes[] = {NSLayoutAttributeRight };
